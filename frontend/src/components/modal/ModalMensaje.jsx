      ...
      <DialogContent dividers>
        ...
        <Box mt={2}>
          <Typography fontSize={16}>
            {" "}
            Estimado <b>{name}</b>, su solicitud esta en proceso de atención, el
            código de seguimiento es: <b> {code}.</b>
          </Typography>
          <Typography fontSize={16} mt={1}>
            {" "}
            Guarde el documento o copie el codigo, para su posterior seguimiento
            en el sistema.
          </Typography>
        </Box>
      </DialogContent>
